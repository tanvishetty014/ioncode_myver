...
from .attendance_summary import router as attendance_summary_router
...
router.include_router(student_notifications_router, prefix="/notifications", tags=["Student Notifications"])
router.include_router(topic_routes.router, tags=["Topic Management"])

# Reports (Including Attendance Status Reports)
router.include_router(attendance_summary_router, prefix="/reports", tags=["Attendance Reports"])
